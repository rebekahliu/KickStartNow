...
project1 = Project.create(
  ...
  description: '<p>One of a kind porcelain plates to spruce up your table setting',
...
project2 = Project.create(
  ...
  description: '<p>These handwoven and hand painted wicker baskets are the perfect summer accessory',
